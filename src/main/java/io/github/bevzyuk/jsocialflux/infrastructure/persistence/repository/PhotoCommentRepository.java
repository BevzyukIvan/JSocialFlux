...
public interface PhotoCommentRepository extends ReactiveCrudRepository<PhotoComment, Long> {
    ...
    SELECT c.id,
     ...
     LIMIT :limit
    """)
    Flux<PhotoCommentDTO> findPageByPhotoIdBefore(Long photoId, Instant ts, long tieId, long limit);
}